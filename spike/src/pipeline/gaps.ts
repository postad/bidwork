import type { ExtractionResult } from "../lib/schema.js";
 ...
 * absence in a vacuum. Mirrors the five detectors in the brief (§4).
 */
export function detectGaps(result: ExtractionResult, cfg: VerticalConfig): Gap[] {
  ...
  // 4 · Referenced-but-not-present (reference chasing — needs the real page set to confirm; flagged for review)
